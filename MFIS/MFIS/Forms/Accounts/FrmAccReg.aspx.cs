...
{
    public partial class FrmAccReg : System.Web.UI.Page
    {
        string query = "";
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                query = @"INSERT into CustReg (SlNo,Pyear,PDate,CustIDNO,CustAccNo,SubDepositCodeNo,DurationOfMonth,MaturedDate,MInterest,InterestDrawStatus,Active_InActive,SV_AccNo,Active_InActive_Date) 
                      VALUES ('" + TxtSlNo.Text + "','" + DateTime.Parse(txtIssueDate.Text).Year + "', '" + txtIssueDate.Text + "', '" + txtCustIDNO.Text + "', '" + txtCustAccNo.Text + "','" + ComSub_DepositScheme.SelectedValue + "', " + txtDuration.Text + ", '" + TxtMaturedDate.Text + "'," + TxtMIntr.Text + ",'" + ComInterestDrawStatus.SelectedValue + "','" + ComActive_InActive.SelectedValue + "','" + TxtSV_AccNo.Text + "', '" + DateTime.Now + "' )";
        ...
        {
            Response.Redirect("NomineePage.aspx?CustAcNo=" + txtCustAccNo.Text);
        }
