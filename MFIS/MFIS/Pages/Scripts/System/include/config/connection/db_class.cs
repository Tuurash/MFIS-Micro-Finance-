...
namespace ACC_WEB_V_0_1.Controllers
{
    public class db_class
    {        
        public SqlConnection conn = new SqlConnection("Data Source=localhost;Initial Catalog=GPAC_ERP;Persist Security Info=True;User ID=sa;Password=sa*1209");     
           //-------------------------------------//
